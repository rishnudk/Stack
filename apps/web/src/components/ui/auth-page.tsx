			...
			<div className="bg-muted/60 relative hidden h-full flex-col border-r p-10 lg:flex">
				...
				<div className="z-10 mt-auto">
					<blockquote className="space-y-2">
						<p className="text-xl">
							&ldquo;Stack has helped me connect with other developers and build my portfolio faster than ever before.&rdquo;
						</p>
				...
				<div className="mx-auto space-y-4 sm:w-sm">
					...
					<div className="flex flex-col space-y-1">
						...
						<p className="text-muted-foreground text-base">
							login or create your Stack account.
						</p>
					</div>
						...
						>
							{isLoading === "google" ? (
								<motion.div
									...
									className="size-4 me-2 border-2 border-current border-t-transparent rounded-full"
								/>
							) : (
