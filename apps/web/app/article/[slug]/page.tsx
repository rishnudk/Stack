    ...
    return (
        <div className="max-w-3xl mx-auto py-10 px-4 sm:px-8">
            <button 
                ...
                className="mb-6 p-2 bg-neutral-900 hover:bg-neutral-800 rounded-full transition-colors inline-flex items-center text-neutral-400 hover:text-white"
                title="Back to Feed"
            >
                <ArrowLeft size={20} />
            </button>
            ...
            {article.image && (
                <img 
                    src={article.image} 
                    alt={article.title} 
                    className="w-full max-h-[400px] border border-neutral-800 object-cover rounded-xl mb-8" 
                />
            )}
